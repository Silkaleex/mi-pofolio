...
function desmarcarTodas() {
  ...
  for (var i = 0; i <= 8; i++) {
    document.getElementById("img_" + i).style.border = "groove 3px #4E54CC";
  }
}
...
function seleccionar(casilla) {
  ...
  if (num_click == 1) {
    ...
    desmarcarTodas();
    document.getElementById("img_" + casilla).style.border =
      "solid 3px #FFE500";
    console.log(
      "Memorizo la casilla del primer click: " + casilla_click_primero
    );
  }
  ...
  if (num_click == 2) {
    ...
    if (correcto == true) {
      ...
      setTimeout(function () {
        alert("Enhorabuena Has compretado El puzle");
      }, 300);
    }
  }
}
...
function refrescarPuzzle() {
  for (var casilla = 0; casilla <= 8; casilla++) {
    ...
    document.getElementById("img_" + casilla).src =
      "imagenes/img_" + imagen + ".jpg";
  }
}
